...
class AuthProvider extends ChangeNotifier {
  ...
  String? get role => _authService.userData?['role'];
  ...
  // Login User (admin, courier, customer)
  Future<bool> loginUser(String phone, String password, String role) async {
    return _performAuthOperation(() async {
      return await _authService.loginUser(phone, password, role);
    });
  }
